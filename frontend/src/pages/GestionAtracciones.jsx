...
import { getAtracciones, crearAtraccion,
         actualizarAtraccion, eliminarAtraccion } from "../services/atraccionService"
...
function GestionAtracciones() {
    ...
    const cargarDatos = useCallback(async () => {
        try {
            const [atr, zon] = await Promise.all([getAtracciones(), getZonas()])
            setAtracciones(atr)
            setZonas(zon)
        } catch {
                            ...
                            <div className="form-group">
                                ...
                                <div className="tipo-opciones">
                                    {["MECANICA", "ACUATICA"].map(t => (
                                        ...
                                        >
                                            <span>{t === "MECANICA" ? "⚙️ Mecánica" : "💧 Acuática"}</span>
                                        </div>
                                    ))}
                                </div>
                            </div>
                        ...
                        <div className="form-grid">
                            ...
                            <div className="form-group">
                                ...
                                <input type="number" step="0.01" min="0"
                                    ...
                                    onChange={e => setForm({
                                        ...form, alturaMinima: e.target.value
                                    })}
                                    required
                                />
                            </div>
                            <div className="form-group">
                                ...
                                <input type="number" min="0"
                                    ...
                                    onChange={e => setForm({
                                        ...form, edadMinima: e.target.value
                                    })}
                                    required
                                />
                            </div>
                            <div className="form-group">
                                ...
                                <input type="number" min="0"
                                    ...
                                    onChange={e => setForm({
                                        ...form, costoExtra: e.target.value
                                    })}
                                    required
                                />
                            </div>
                            ...
                            {!editando && form.tipo === "MECANICA" && (
                                <div className="form-group">
                                    ...
                                    <input type="number" min="0"
                                        ...
                                        onChange={e => setForm({
                                            ...form, velocidadMax: e.target.value
                                        })}
                                        required
                                    />
                                </div>
                            ...
                            {!editando && form.tipo === "ACUATICA" && (
                                <div className="form-group">
                                    ...
                                    <input type="number" step="0.1" min="0"
                                        ...
                                        onChange={e => setForm({
                                            ...form, profundidad: e.target.value
                                        })}
                                        required
                                    />
                                </div>
            ...
            {confirmEliminar && (
                <div className="modal-overlay">
                    <div className="modal">
                        ...
                        <p>¿Eliminar la atracción <strong>{confirmEliminar}</strong>?</p>
                        <p className="modal-advertencia">
                            La atracción quedará marcada como CERRADA
                            y se eliminará de su zona.
                        </p>
