...
import { getAlertaClimatica, activarAlerta,
         desactivarAlerta, getReporte } from "../services/adminService"
import "./Admin.css"
    ...
    async function handleActivarAlerta(e) {
        ...
        try {
            const resultado = await activarAlerta(
                formAlerta.tipo, formAlerta.descripcion
            )
            if (resultado.exito) {
                mostrarMensaje("exito",
        ...
        <div className="admin">
            ...
            {alerta && (
                <div className="alerta-activa">
                    <span>⚠️ ALERTA ACTIVA: {alerta.tipo} — {alerta.descripcion}</span>
                            ...
                            <form onSubmit={handleActivarAlerta}>
                                ...
                                <div className="form-group">
                                    ...
                                    <textarea
                                        ...
                                        onChange={e => setFormAlerta({
                                            ...formAlerta, descripcion: e.target.value
                                        })}
                                        required
                                    />
                                </div>
